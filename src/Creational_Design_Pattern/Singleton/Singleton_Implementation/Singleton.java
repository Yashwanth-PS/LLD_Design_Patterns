...
public class Singleton {
    ...
    public static Singleton getInstance() { // Step 3: Since we don’t have an object, Make the method static
        if (instance == null) { // Step 4b: Introduce a check in getObject() method
            synchronized (Singleton.class) { // Step 5: Double Check Locking  Take lock using class
                if (instance == null) {
